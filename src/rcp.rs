...
impl OnionMessageReader {
    ...
    fn new(message: ::capnp::message::Reader<::capnp::serialize::OwnedSegments>) -> OnionMessageReader {
        OnionMessageReader{
            message: message
        }
    }

    pub fn new_from_buffer(mut buffer: &[u8]) -> capnp::Result<OnionMessageReader> {
...
impl OnionMessageReader {
    pub fn get<'a>(&'a self) -> ::capnp::Result<::onion_capnp::onion_message::Reader> {
